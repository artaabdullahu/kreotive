...
(function () {
        ...
        return {
            define: function (b, d) {
                ...
                if (0 > f.getListenerIndex(d)) {
                    ...
                    q.fn = d;
                    q.priority = l;
                    for (var A = f.length - 1; 0 <= A; A--)if (f[A].priority <= l)return f.splice(A + 1, 0, q), {removeListener: v};
                    f.unshift(q)
                }
            ...
            once: function () {
                ...
                return function (l, q, v) {
                    ...
                    if (f) {
                        var A = f.listeners;
                        if (A.length)for (var A = A.slice(0), r, D = 0; D < A.length; D++) {
                            if (f.errorProof)try {
                                r =
                                    A[D].call(this, v, q, b, k)
                            } catch (n) {
                            } else r = A[D].call(this, v, q, b, k);
    ...
    CKEDITOR.dom = {};
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, e = /</g, g = /"/g, k = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, l = {
            lt: "\x3c",
            gt: "\x3e",
            amp: "\x26",
            quot: '"',
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function (a, f) {
                var b = f == CKEDITOR.ENTER_BR, c = this.htmlEncode(a.replace(/\r\n/g, "\n")), c = c.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;"), l = f == CKEDITOR.ENTER_P ? "p" : "div";
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c))var n = "\x3c" + l + "\x3e", q = "\x3c/" + l + "\x3e", c = n + c.replace(d, function () {
                            return q + n
                        }) + q
                }
                c = c.replace(/\n/g, "\x3cbr\x3e");
            ...
            createClass: function (a) {
                var f = a.$, b = a.base, c = a.privates || a._, l = a.proto;
                a = a.statics;
                !f && (f = function () {
                    b && this.base.apply(this, arguments)
                });
                if (c)var d = f, f = function () {
            ...
            normalizeCssText: function (a, b) {
                var c = [], l, d = CKEDITOR.tools.parseCssText(a, !0, b);
            ...
            normalizeHex: function (a) {
                return a.replace(/#(([0-9a-f]{3}){1,2})($|;|\s+)/gi, function (a, b, c, l) {
                    a = b.toLowerCase();
            ...
            parseCssText: function (a, b, c) {
                ...
                a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g,
                    function (a, c, d) {
                        b && (c = c.toLowerCase(), "font-family" == c && (d = d.replace(/\s*,\s*/g, ",")), d = CKEDITOR.tools.trim(d));
                        l[c] = d
                    });
                return l
            },
            ...
            objectCompare: function (a, b, c) {
                ...
                if (!a && !b)return !0;
                if (!a || !b)return !1;
                for (l in a)if (a[l] != b[l])return !1;
                if (!c)for (l in b)if (a[l] != b[l])return !1;
                return !0
            },
            ...
            enableHtml5Elements: function (a,
                                           b) {
                for (var c = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), l = c.length, d; l--;)d = a.createElement(c[l]), b && a.appendChild(d)
            },
            checkIfAnyArrayItemMatches: function (a, b) {
                for (var c = 0, l = a.length; c < l; ++c)if (a[c].match(b))return !0;
                return !1
            },
            ...
            getCookie: function (a) {
                a = a.toLowerCase();
                for (var b = document.cookie.split(";"), c, l, d = 0; d < b.length; d++)if (c = b[d].split("\x3d"), l = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), l === a)return decodeURIComponent(1 < c.length ? c[1] : "");
                return null
            },
            ...
            getCsrfToken: function () {
                ...
                if (!a || 40 != a.length) {
                    ...
                    if (window.crypto && window.crypto.getRandomValues)a =
                        new Uint8Array(40), window.crypto.getRandomValues(a); else for (var c = 0; 40 > c; c++)a.push(Math.floor(256 * Math.random()));
                    for (c = 0; c < a.length; c++)var l = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[c] % 36), b = b + (.5 < Math.random() ? l.toUpperCase() : l);
                    a = b;
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
            ...
            table: 1,
            ul: 1
        }, g = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, k = {}, l = {"#": 1}, q = {
            center: 1,
            dir: 1,
            noframes: 1
        };
        a(b, {
            ...
            video: 1,
            wbr: 1
        }, l, {acronym: 1, applet: 1, basefont: 1, big: 1, font: 1, isindex: 1, strike: 1, style: 1, tt: 1});
        a(c, e, b, q);
        d = {
            a: d(b, {a: 1, button: 1}),
            abbr: b,
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (a) {
            ...
            for (var b =
                ...
                var e = a[c];
                if (d)for (var g = -1, k = 0; k < b.childNodes.length; k++) {
                    var l = b.childNodes[k];
                    if (!0 !== d || 3 != l.nodeType || !l.previousSibling || 3 != l.previousSibling.nodeType)if (g++, g == e) {
                        b = l;
                        break
                    }
    ...
    (function () {
        ...
        function c(a) {
            for (var b = 0, c = 0, f = k[a].length; c < f; c++)b += parseInt(this.getComputedStyle(k[a][c]) || 0, 10) || 0;
            return b
        }

        var e = document.createElement("_").classList, e = "undefined" !== typeof e &&
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            type: CKEDITOR.NODE_ELEMENT, addClass: e ? function (a) {
                ...
                c.setEndAfter(a);
                var f = c.extractContents(!1, b || !1), d;
            ...
            is: function () {
                ...
                function a(b, c, f) {
                    if (c && c.type == CKEDITOR.NODE_ELEMENT) {
                        for (var d =
                            []; c.data("cke-bookmark") || c.isEmptyInlineRemoveable();)if (d.push(c), c = f ? c.getNext() : c.getPrevious(), !c || c.type != CKEDITOR.NODE_ELEMENT)return;
                        if (b.isIdentical(c)) {
                ...
                if (b.removeProperty || "border" != a && "margin" != a && "padding" != a)b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
                    ...
                    for (var b = [], d = 0; d < c.length; d++)if (f)for (var e =
                        0; e < f.length; e++)b.push([a, c[d], f[e]].join("-")); else b.push([a, c[d]].join("-"));
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var r = this.$.getBoundingClientRect(), g = f.$.documentElement, n = g.clientTop || d.$.clientTop || 0, w = g.clientLeft || d.$.clientLeft || 0, k = !0;
                    CKEDITOR.env.ie && (k = f.getDocumentElement().contains(this), f = f.getBody().contains(this), k = e && f || !e && k);
                    k && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || g.scrollLeft, c = d.$.scrollTop || g.scrollTop) : (c = e ? d.$ : g, b = c.scrollLeft, c = c.scrollTop), b = r.left + b - w, c = r.top + c - n)
                } else for (n = this, w = null; n && "body" != n.getName() &&
                "html" != n.getName();) {
                    b += n.$.offsetLeft - n.$.scrollLeft;
                    c += n.$.offsetTop - n.$.scrollTop;
                    n.equals(this) || (b += n.$.clientLeft || 0, c += n.$.clientTop || 0);
                    for (; w && !w.equals(n);)b -= w.$.scrollLeft, c -= w.$.scrollTop, w = w.getParent();
                    w = n;
                    n = (r = n.$.offsetParent) ? new CKEDITOR.dom.element(r) : null
                }
                a && (r = this.getWindow(), n = a.getWindow(), !r.equals(n) && r.$.frameElement && (a = (new CKEDITOR.dom.element(r.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
                ...
                function n(a, b) {
                    ...
                    f = a.getWindow();
                    f.equals(b) || (f = n(CKEDITOR.dom.element.get(f.$.frameElement), b), c.x += f.x, c.y += f.y);
                    return c
                }
                ...
                e = a.getWindow();
                d = n(this, e);
                var u = n(a, e), t = this.$.offsetHeight;
                f = this.$.offsetWidth;
                var h = a.$.clientHeight, p = a.$.clientWidth;
                e = d.x - w(this, "left") - u.x || 0;
                r = d.y - w(this, "top") - u.y || 0;
                f = d.x + f + w(this, "right") - (u.x + p) || 0;
                d = d.y + t + w(this, "bottom") - (u.y + h) || 0;
                (0 > r || 0 < d) && g(0, !0 === b ? r : !1 === b ? d : 0 > r ? r : d);
                ...
                switch (a) {
                    case CKEDITOR.TRISTATE_ON:
                        ...
                        c && this.setAttribute("aria-pressed",
                            !0);
                ...
                for (var f = 0; f < c.length; f++) {
                    var d = c[f], e = d.nodeName.toLowerCase(), r;
                    if (!(e in b))if ("checked" == e && (r = this.getAttribute(e)))a.setAttribute(e, r); else if (!CKEDITOR.env.ie || this.hasAttribute(e))r = this.getAttribute(e), null === r && (r = d.nodeValue), a.setAttribute(e, r)
                }
        ...
        CKEDITOR.dom.element.prototype.getSize =
            function (a, b) {
    ...
    (function () {
        function a(a, b) {
            ...
            f = c.endContainer;
            var e = c.startOffset, y = c.endOffset, t, h = this.guard, p = this.type, m = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var x = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(), z = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(y) : f.getNext();
                this._.guardLTR = function (a, b) {
                    return (!b || !x.equals(a)) && (!z || !a.equals(z)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var F = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), g = d.type == CKEDITOR.NODE_ELEMENT ? e ? d.getChild(e - 1) : null : d.getPrevious();
            ...
            t = h ? function (a, b) {
                return !1 === k(a, b) ? !1 : h(a, b)
            } : k;
            this.current ? f = this.current[m](!1, p, t) : (a ? f.type == CKEDITOR.NODE_ELEMENT &&
            (f = 0 < y ? f.getChild(y - 1) : !1 === t(f, !0) ? null : f.getPreviousSourceNode(!0, p, t)) : (f = d, f.type == CKEDITOR.NODE_ELEMENT && ((f = f.getChild(e)) || (f = !1 === t(d, !0) ? null : d.getNextSourceNode(!0, p, t)))), f && !1 === t(f) && (f = null));
            for (; f && !this._.end;) {
                this.current = f;
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(), k = CKEDITOR.dom.walker.bookmark(), l = CKEDITOR.dom.walker.temp(), q = function (a) {
        ...
        CKEDITOR.dom.walker.empty = function (a) {
            return function (b) {
                for (var c = 0, f = b.getChildCount(); c < f; ++c)if (!v(b.getChild(c)))return !!a;
                return !a
            }
        };
        var f = CKEDITOR.dom.walker.empty(), y = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) {
            var b = {}, c;
        ...
        CKEDITOR.dom.walker.editable = function (a) {
            return function (b) {
                b =
                    v(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(y) && f(b)) ? !0 : !1;
                return !!(a ^ b)
            }
        };
    ...
    (function () {
        ...
        function d(a, b, c, d, e) {
            function n(a, b, c, f) {
                ...
                if (f && l)return d;
                h || f ? b.append(a.clone(!0, e), c) : (a.remove(), t && b.append(a));
                return d
            }

            function g() {
                var a, b, c, f = Math.min(N.length, C.length);
                for (a = 0; a < f; a++)if (b = N[a], c = C[a], !b.equals(c))return a;
                return a - 1
            }

            function k() {
                var b = I - 1, c = E && v && !p.equals(m);
                b < G - 1 || b < K - 1 || c ? (c ? a.moveToPosition(m,
            ...
            a.optimizeBookmark();
            var l = 0 === b, t = 1 == b, h = 2 == b;
            b = h || t;
            var p = a.startContainer, m = a.endContainer,
                x = a.startOffset, z = a.endOffset, F, B, E, v, q, O;
            if (h && m.type == CKEDITOR.NODE_TEXT && p.equals(m))p = a.document.createText(p.substring(x, z)), c.append(p); else {
                m.type == CKEDITOR.NODE_TEXT ? h ? O = !0 : m = m.split(z) : 0 < m.getChildCount() ? z >= m.getChildCount() ? (m = m.getChild(z - 1), B = !0) : m = m.getChild(z) : v = B = !0;
                p.type == CKEDITOR.NODE_TEXT ? h ? q = !0 : p.split(x) : 0 < p.getChildCount() ? 0 === x ? (p = p.getChild(x), F = !0) : p = p.getChild(x - 1) : E = F = !0;
                for (var N = p.getParents(), C = m.getParents(), I = g(), G = N.length - 1, K = C.length - 1, J = c, L, Z, U, fa = -1, Q = I; Q <= G; Q++) {
                    Z =
                        N[Q];
                    U = Z.getNext();
                    for (Q != G || Z.equals(C[Q]) && G < K ? b && (L = J.append(Z.clone(0, e))) : F ? n(Z, J, !1, E) : q && J.append(a.document.createText(Z.substring(x))); U;) {
                        if (U.equals(C[Q])) {
                            fa = Q;
                            break
                        }
                ...
                J = c;
                for (Q = I; Q <= K; Q++)if (c = C[Q], U = c.getPrevious(), c.equals(N[Q]))b && (J = J.getChild(0)); else {
                    Q != K || c.equals(N[Q]) && K < G ? b && (L = J.append(c.clone(0, e))) : B ? n(c, J, !1, v) : O && J.append(a.document.createText(c.substring(0, z)));
                    if (Q > fa)for (; U;)U = n(U, J, !0);
                    J = L
                }
                h || k()
            }
        ...
        var g = {
            ...
            u: 1,
            "var": 1
        }, k = CKEDITOR.dom.walker.bogus(), l = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, q = CKEDITOR.dom.walker.editable(), v = CKEDITOR.dom.walker.ignored(!0);
            ...
            clone: function () {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var g = this.getCommonAncestor(), k = this.root, l, t, h, p, m, x = !1, z, F;
                        z = this.startContainer;
                        var B = this.startOffset;
                        z.type == CKEDITOR.NODE_TEXT ? (B && (z = !CKEDITOR.tools.trim(z.substring(0, B)).length && z, x = !!z), z && ((p = z.getPrevious()) || (h = z.getParent()))) : (B && (p = z.getChild(B - 1) || z.getLast()), p || (h = z));
                        for (h = c(h); h || p;) {
                            if (h && !p) {
                                !m && h.equals(g) && (m = !0);
                                if (e ? h.isBlockBoundary() :
                                        !k.contains(h))break;
                                x && "inline" == h.getComputedStyle("display") || (x = !1, m ? l = h : this.setStartBefore(h));
                                p = h.getPrevious()
                            }
                            for (; p;)if (z = !1, p.type == CKEDITOR.NODE_COMMENT)p = p.getPrevious(); else {
                                if (p.type == CKEDITOR.NODE_TEXT)F = p.getText(), d.test(F) && (p = null), z = /[\s\ufeff]$/.test(F); else if ((p.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && p.is("br")) && !p.data("cke-bookmark"))if (x && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                    F = p.getText();
                                    if (d.test(F))p = null; else for (var B = p.$.getElementsByTagName("*"), E = 0, v; v =
                                        B[E++];)if (!CKEDITOR.dtd.$removeEmpty[v.nodeName.toLowerCase()]) {
                                        p = null;
                                        break
                                    }
                                    p && (z = !!F.length)
                                } else p = null;
                                z && (x ? m ? l = h : h && this.setStartBefore(h) : x = !0);
                                if (p) {
                                    z = p.getPrevious();
                                    if (!h && !z) {
                                        h = p;
                        ...
                        h = p = null;
                        m = x = !1;
                        z.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(z.substring(B)).length ? x = !0 : (x = !z.getLength(), B == z.getLength() ? (p = z.getNext()) || (h = z.getParent()) : n(z, B) && (h = z.getParent())) : (p = z.getChild(B)) || (h = z);
                        for (; h ||
                               p;) {
                            if (h && !p) {
                                !m && h.equals(g) && (m = !0);
                                if (e ? h.isBlockBoundary() : !k.contains(h))break;
                                x && "inline" == h.getComputedStyle("display") || (x = !1, m ? t = h : h && this.setEndAfter(h));
                                p = h.getNext()
                            }
                            for (; p;) {
                                z = !1;
                                if (p.type == CKEDITOR.NODE_TEXT)F = p.getText(), n(p, 0) || (p = null), z = /^[\s\ufeff]/.test(F); else if (p.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < p.$.offsetWidth || b && p.is("br")) && !p.data("cke-bookmark"))if (x && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                        F = p.getText();
                                        if (d.test(F))p = null; else for (B = p.$.getElementsByTagName("*"), E =
                                            0; v = B[E++];)if (!CKEDITOR.dtd.$removeEmpty[v.nodeName.toLowerCase()]) {
                                            p = null;
                                            break
                                        }
                                        p && (z = !!F.length)
                        ...
                        l && t && (g = l.contains(t) ? t : l, this.setStartBefore(g), this.setEndAfter(g));
                        break;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var q, O, N = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), C = null, I = function (a) {
                            if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable"))if (C) {
                                if (C.equals(a)) {
                                    C = null;
                                    return
                                }
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            h = this.clone();
                            h = new CKEDITOR.dom.walker(h);
                            var G = CKEDITOR.dom.walker.whitespaces(), K = CKEDITOR.dom.walker.bookmark();
                ...
                if (!this.collapsed) {
                    ...
                    var d = this.clone(), e = this.startContainer, n = this.endContainer, g = this.startOffset, k = this.endOffset, l = 1, t = 1;
                    e && e.type == CKEDITOR.NODE_TEXT && (g ? g >= e.getLength() ? d.setStartAfter(e) : (d.setStartBefore(e), l = 0) : d.setStartBefore(e));
                    n && n.type == CKEDITOR.NODE_TEXT && (k ? k >= n.getLength() ? d.setEndAfter(n) :
                        (d.setEndAfter(n), t = 0) : d.setEndBefore(n));
                    ...
                    t && (d.reset(), (d = d[a == CKEDITOR.SHRINK_ELEMENT ? "lastBackward" : "previous"]()) && this.setEndAt(d, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_END));
                    return !(!l && !t)
                }
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root), d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), e = c.block, n = d.block, g = null;
                ...
                this.deleteContents();
                e && e.equals(n) &&
                (d ? (g = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(n, CKEDITOR.POSITION_AFTER_END), n = null) : c ? (g = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START), e = null) : (n = this.splitElement(e, b || !1), e.is("ul", "ol") || e.appendBogus()));
                return {previousBlock: e, nextBlock: n, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: g}
                ...
                for (var c = 0; a;) {
                    ...
                    d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(!1) && (n = d[b ? "getLast" : "getFirst"](v));
                    e || n || (n = d[b ? "getPrevious" : "getNext"](v));
                    a = n
                }
                return !!c
            }, moveToClosestEditablePosition: function (a, b) {
                var c, d = 0, e, n, g = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
                a ? (c = new CKEDITOR.dom.range(this.root), c.moveToPosition(a, g[b ? 0 : 1])) : c = this.clone();
                if (a && !a.is(CKEDITOR.dtd.$block))d = 1; else if (e = c[b ? "getNextEditableNode" : "getPreviousEditableNode"]())d = 1, (n = e.type == CKEDITOR.NODE_ELEMENT) &&
                e.is(CKEDITOR.dtd.$block) && "false" == e.getAttribute("contenteditable") ? (c.setStartAt(e, CKEDITOR.POSITION_BEFORE_START), c.setEndAt(e, CKEDITOR.POSITION_AFTER_END)) : !CKEDITOR.env.needsBrFiller && n && e.is(CKEDITOR.dom.walker.validEmptyBlockContainers) ? (c.setEnd(e, 0), c.collapse()) : c.moveToPosition(e, g[b ? 1 : 0]);
    ...
    (function () {
        ...
        function b(a, c, e, g) {
            a:{
                null == g && (g = d(e));
                for (var k; k = g.shift();)if (k.getDtd().p) {
                    g = {element: k, remaining: g};
                    break a
                }
                g = null
            }
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    k = n.startPath();
                    var w = n.endPath(), H = !n.collapsed && c(n, k.block), u = !n.collapsed && c(n, w.block, 1);
                    n.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
                    H && n.setStartAt(k.block, CKEDITOR.POSITION_BEFORE_END);
                    u && n.setEndAt(w.block, CKEDITOR.POSITION_AFTER_START);
                    k = n.endContainer.hasAscendant("pre", !0) || n.startContainer.hasAscendant("pre", !0);
                    ...
                    (w = new CKEDITOR.dom.elementPath(w.endContainer, w.root), this._.lastNode = (w.block || w.blockLimit).getNextSourceNode(!0))), this._.lastNode && n.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = n.document.createText(""), this._.lastNode.insertAfter(k)), n = null);
                    this._.started = 1;
                    k = n
                }
                w = this._.nextNode;
                n = this._.lastNode;
                for (this._.nextNode = null; w;) {
                    var H = 0, u = w.hasAscendant("pre"), t = w.type != CKEDITOR.NODE_ELEMENT, h = 0;
                    if (t)w.type == CKEDITOR.NODE_TEXT && e.test(w.getText()) && (t = 0); else {
                        var p = w.getName();
                        if (CKEDITOR.dtd.$block[p] && "false" == w.getAttribute("contenteditable")) {
                            d = w;
                            b(this, a, d);
                            break
                        } else if (w.isBlockBoundary(this.forceBrBreak && !u && {br: 1})) {
                            if ("br" == p)t = 1; else if (!k && !w.getChildCount() && "hr" != p) {
                                d = w;
                                A = w.equals(n);
                                break
                            }
                            k && (k.setEndAt(w, CKEDITOR.POSITION_BEFORE_START), "br" != p && (this._.nextNode = w));
                            H = 1
                        } else {
                            if (w.getFirst()) {
                                k || (k = this.range.clone(), k.setStartAt(w, CKEDITOR.POSITION_BEFORE_START));
                                w = w.getFirst();
                                continue
                            }
                            t = 1
                    ...
                    t && !k && (k = this.range.clone(), k.setStartAt(w, CKEDITOR.POSITION_BEFORE_START));
                    A = (!H || t) && w.equals(n);
                    if (k && !H)for (; !w.getNext(l) && !A;) {
                        p = w.getParent();
                    ...
                    t && k.setEndAt(w, CKEDITOR.POSITION_AFTER_END);
                    w = this._getNextSourceNode(w, h, n);
                    if ((A = !w) || H && k)break
                }
                if (!d) {
                    ...
                    H = {div: 1, th: 1, td: 1};
                    d = d.block;
                    !d && w && !this.enforceRealBlocks && H[w.getName()] && k.checkStartOfBlock() && k.checkEndOfBlock() && !w.equals(k.root) ? d = w : !d || this.enforceRealBlocks && d.is(q) ? (d = this.range.document.createElement(a), k.extractContents().appendTo(d), d.trim(), k.insertNode(d), r = D = !0) : "li" != d.getName() ? k.checkStartOfBlock() && k.checkEndOfBlock() || (d = d.clone(!1), k.extractContents().appendTo(d), d.trim(), D = k.splitBlock(), r = !D.wasStartOfBlock, D = !D.wasEndOfBlock, k.insertNode(d)) : A || (this._.nextNode = d.equals(n) ? null : this._getNextSourceNode(k.getBoundaryNodes().endNode,
                        1, n))
                }
                r && (r = d.getPrevious()) && r.type == CKEDITOR.NODE_ELEMENT && ("br" == r.getName() ? r.remove() : r.getLast() && "br" == r.getLast().$.nodeName.toLowerCase() && r.getLast().remove());
                D && (r = d.getLast()) && r.type == CKEDITOR.NODE_ELEMENT && "br" == r.getName() && (!CKEDITOR.env.needsBrFiller || r.getPrevious(g) || r.getNext(g)) && r.remove();
    ...
    (function () {
        function a(a, b, c, d, e) {
            ...
            for (h in b) {
                p = b[h];
                p = "boolean" == typeof p ? {} : "function" == typeof p ? {match: p} : E(p);
                "$" != h.charAt(0) && (p.elements = h);
                c && (p.featureName = c.toLowerCase());
                var m = p;
                m.elements = k(m.elements, /\s+/) || null;
                m.propertiesOnly = m.propertiesOnly || !0 === m.elements;
                var f = /\s*,\s*/, n = void 0;
                for (n in O) {
                    m[n] = k(m[n], f) || null;
                    var G = m, t = N[n], g = k(m[N[n]], f), x = m[n], F = [], C = !0, K = void 0;
                    g ? C = !1 : g = {};
                    for (K in x)"!" == K.charAt(0) && (K = K.slice(1), F.push(K), g[K] = !0, C = !1);
                    for (; K = F.pop();)x[K] =
                        x["!" + K], delete x["!" + K];
                    G[t] = (C ? !1 : g) || null
                }
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (n in N) {
                    ...
                    g = [];
                    x = void 0;
                    for (x in t)-1 < x.indexOf("*") ? g.push(new RegExp("^" + x.replace(/\*/g, ".*") + "$")) : g.push(x);
                    t = g;
                    t.length && (m[f] = t, G = !1)
                }
                m.nothingRequired = G;
                ...
                if (!0 === h.elements ||
                    null === h.elements)e[p ? "unshift" : "push"](h); else for (z in m = h.elements, delete h.elements, m)if (b[z])b[z][p ? "unshift" : "push"](h); else b[z] = [h]
            }
        }
        ...
        function f(a) {
            var b, c, d, h, p = {}, e = 1;
            for (a = Y(a); b = a.match(C);)(c = b[2]) ? (d = y(c, "styles"), h = y(c, "attrs"), c = y(c, "classes")) : d = h = c = null, p["$" + e++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: h
        ...
        function r(a, b, h, e) {
            ...
            if (e.doCallbacks && a.elementCallbacks) {
                a:{
                    ...
                    for (var g = 0, t = f.length, x; g < t; ++g)if (x = f[g](b)) {
                        f = x;
                        break a
                    }
                    f = void 0
            ...
            if (e.doTransform && (f = a._.transformations[b.name])) {
                A(b);
                for (g = 0; g < f.length; ++g)p(a, b, f[g]);
                n(b)
            }
            if (e.doFilter) {
                a:{
                    g = b.name;
                    t = a._;
                    a = t.allowedRules.elements[g];
                    f = t.allowedRules.generic;
                    g = t.disallowedRules.elements[g];
                    t = t.disallowedRules.generic;
                    x = e.skipRequired;
                    var F = {
                        valid: !1,
                        validAttributes: {},
                    ...
                    if (a || f) {
                        A(b);
                        if (g)for (k = 0, C = g.length; k < C; ++k)if (!1 === c(g[k], b, F)) {
                            a = null;
                            break a
                        }
                        if (t)for (k = 0, C = t.length; k < C; ++k)c(t[k], b, F);
                        if (a)for (k = 0, C = a.length; k < C; ++k)d(a[k], b, F, x);
                        if (f)for (k = 0, C = f.length; k < C; ++k)d(f[k], b, F, x);
                        a = F
                    } else a = null
                }
                ...
                var z = a.validStyles;
                f = a.validClasses;
                var g = b.attributes, l = b.styles, t = b.classes;
                x = b.classBackup;
                var J = b.styleBackup, B, I, E = [], F = [], q = /^data-cke-/;
                k = !1;
                delete g.style;
                delete g["class"];
                delete b.classBackup;
                delete b.styleBackup;
                if (!a.allAttributes)for (B in g)C[B] || (q.test(B) ? B == (I = B.replace(/^data-cke-saved-/, "")) || C[I] || (delete g[B], k = !0) : (delete g[B], k = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (B in l)a.allStyles || z[B] ? E.push(B + ":" + l[B]) : k = !0;
                    E.length && (g.style = E.sort().join("; "))
                } else J && (g.style = J);
                if (!a.allClasses ||
                    a.hadInvalidClass) {
                    for (B = 0; B < t.length; ++B)(a.allClasses || f[t[B]]) && F.push(t[B]);
                    F.length && (g["class"] = F.sort().join(" "));
                    x && F.length < x.split(/\s+/).length && (k = !0)
                } else x && (g["class"] = x);
                k && (m = 1);
                if (!e.skipFinalValidation && !w(b))return h.push(b), 1
            }
            e.toHtml && (b.name = b.name.replace(K, "cke:$1"));
            return m
        }
        ...
        function h(a, b, c) {
            var d = a.name;
            if (B.$empty[d] || !a.children.length)"hr" == d && "br" == b ? a.replaceWith(u()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (B.$block[d] || "tr" == d)if ("br" == b)a.previous && !t(a.previous) && (b = u(), b.insertBefore(a)), a.next && !t(a.next) && (b = u(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, h;
                b:{
                    h = B[b];
                ...
                {}, c.push({check: "parent-down", el: a}); else {
                    h = a.parent;
                    for (var p = h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == h.name, f, g, e = d.length; 0 < e;)m = d[--e], p && (m.type == CKEDITOR.NODE_TEXT || m.type == CKEDITOR.NODE_ELEMENT && B.$inline[m.name]) ? (f || (f = new CKEDITOR.htmlParser.element(b), f.insertAfter(a), c.push({
                        check: "parent-down",
                        el: f
                    })), f.add(m, 0)) : (f = null, g = B[h.name] || B.span, m.insertAfter(a), h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || m.type != CKEDITOR.NODE_ELEMENT || g[m.name] || c.push({
                        check: "el-up",
                        el: m
                    }));
                    a.remove()
        ...
        function m(a, b) {
            var c = b.getDefinition(), d = c.attributes, h = c.styles, p, e, m, f;
            if (a.name != c.element)return !1;
            for (p in d)if ("class" == p)for (c = d[p].split(/\s+/), m = a.classes.join("|"); f = c.pop();) {
        ...
        var B = CKEDITOR.dtd, E = CKEDITOR.tools.copy, Y = CKEDITOR.tools.trim, P = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter = function (a) {
            ...
            if (a instanceof CKEDITOR.editor) {
                ...
                !0 === b ? this.disabled = !0 : (b || (this.customConfig = !1), this.allow(b, "config", 1), this.allow(a.config.extraAllowedContent, "extra", 1), this.allow(P[a.enterMode] + " " + P[a.shiftEnterMode], "default",
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                if ("string" == typeof b)b = f(b); else if (b instanceof CKEDITOR.style) {
                    ...
                    d && (d =
                        E(d), h.classes = d["class"] ? d["class"].split(/\s+/) : null, h.requiredClasses = h.classes, delete d["class"], h.attributes = d, h.requiredAttributes = d && CKEDITOR.tools.objectKeys(d))
                ...
                var p = this, e = [], m = this.editor && this.editor.config.protectedSource, f, g = !1, n = {
                    doFilter: !c,
                    doTransform: !0,
                    doCallbacks: !0,
                    toHtml: b
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))if (f = r(p, a, e, n), f & 1)g = !0; else if (f & 2)return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var h, t, x;
                            if (m)for (t = 0; t < m.length; ++t)if ((x = d.match(m[t])) && x[0].length == d.length) {
                                c = !0;
                                break a
                            }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                            1 == d.children.length && (h = d.children[0]).type == CKEDITOR.NODE_ELEMENT && r(p, h, c, n);
                            c = !c.length
                        }
                        c || e.push(a)
                    }
                ...
                var t;
                a = [];
                d = P[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)];
                for (var x; c = e.pop();)c.type == CKEDITOR.NODE_ELEMENT ? h(c, d, a) : c.remove();
                for (; t = a.pop();)if (c = t.el, c.parent)switch (x = B[c.parent.name] || B.span, t.check) {
                    case "it":
                        B.$removeEmpty[c.name] && !c.children.length ? h(c, d, a) : w(c) || h(c, d, a);
                        break;
                    case "el-up":
                        c.parent.type ==
                        CKEDITOR.NODE_DOCUMENT_FRAGMENT || x[c.name] || h(c, d, a);
                        break;
                    case "parent-down":
                        c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || x[c.name] || h(c.parent, d, a)
                }
                return g
            ...
            addContentForms: function (a) {
                if (!this.disabled && a) {
                    ...
                    if (h) {
                        for (b = 0; b < a.length; ++b)d.push(x(a[b], h));
                ...
                if (!this.disabled && a) {
                    ...
                    for (h = 0; h < a.length; ++h) {
                        b = a[h];
                        var p = void 0, e = void 0, m = void 0, f = void 0, g = void 0, t = void 0;
                        c = [];
                        for (e = 0; e < b.length; ++e)m = b[e], "string" == typeof m ? (m = m.split(/\s*:\s*/), f = m[0], g = null, t = m[1]) : (f = m.check, g = m.left, t = m.right), p || (p = m, p = p.element ? p.element : f ? f.match(/^([a-z0-9]+)/i)[0] :
                            p.left.getDefinition().element), g instanceof CKEDITOR.style && (g = z(g)), c.push({
                            check: f == p ? null : f,
                            left: g,
                            right: "string" == typeof t ? F(t) : t
                        });
                        b = p;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                ...
                if ("string" == typeof a) {
                    ...
                    d.styles = v(h);
                    d.attributes = v(d.attributes);
                    d.children = [];
                    m.length && (d.attributes["class"] = m.join(" "));
                    h && (d.attributes.style = CKEDITOR.tools.writeCssText(d.styles));
                    h = d
                } else d = a.getDefinition(), h = d.styles, m = d.attributes || {}, h && !CKEDITOR.tools.isEmpty(h) ? (h = E(h), m.style = CKEDITOR.tools.writeCssText(h, !0)) : h = {}, h = {
                    name: d.element,
                    attributes: m,
                ...
                var m = CKEDITOR.tools.clone(h), g = [], t;
                if (!1 !== b && (t = this._.transformations[h.name])) {
                    for (d =
                             0; d < t.length; ++d)p(this, h, t[d]);
                    n(h)
                }
                r(this, m, g, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
        ...
        var O = {styles: 1, attributes: 1, classes: 1}, N = {
                styles: "requiredStyles",
                attributes: "requiredAttributes",
                classes: "requiredClasses"
            }, C = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, I = {
                styles: /{([^}]+)}/,
                attrs: /\[([^\]]+)\]/,
                classes: /\(([^\)]+)\)/
            }, G = /^cke:(object|embed|param)$/,
            K = /^(object|embed|param)$/, J;
            ...
            sizeToStyle: function (a) {
                ...
                if ("string" == typeof b)a.name = b; else {
                    var c = b.getDefinition(), d = c.styles,
                        h = c.attributes, p, e, m, f;
                    a.name = c.element;
                    for (p in h)if ("class" == p)for (c = a.classes.join("|"), m = h[p].split(/\s+/); f = m.pop();)-1 == c.indexOf(f) && a.classes.push(f); else a.attributes[p] = h[p];
    ...
    (function () {
        var a, d = function (b) {
            b = b.data;
            var d = b.getKeystroke(), g = this.keystrokes[d], k = this._.editor;
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (b, c, e, g) {
                ...
                k && (b = [b]);
                e || (e = CKEDITOR);
                var l = b.length, q = [], v = [], f = function (a) {
                    c && (k ? c.call(e, a) : c.call(e, q, v))
                };
                if (0 === l)f(!0); else {
                    var y = function (a, b) {
                        (b ? q : v).push(a);
                        ...
                        if (a[b])y(b, !0); else {
                            ...
                            if (!(1 < e.length)) {
                                ...
                                c && (CKEDITOR.env.ie && 8 >= CKEDITOR.env.version ? f.$.onreadystatechange = function () {
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) {
            ...
            for (var c = this.loaded, e = this.registered, g = [], k = {}, l = {}, q = 0; q < a.length; q++) {
                var v = a[q];
                if (v)if (c[v] || e[v])l[v] = this.get(v); else {
                    var f = this.getFilePath(v);
                    g.push(f);
                    f in k || (k[f] =
                        []);
                    k[f].push(v)
            ...
            CKEDITOR.scriptLoader.load(g, function (a, e) {
                ...
                for (var f = 0; f < a.length; f++)for (var g = k[a[f]], n = 0; n < g.length; n++) {
                    var w = g[n];
                    l[w] = this.get(w);
                    c[w] = 1
                }
        ...
        return function (b, c, e) {
            var g = {}, k = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], f;
                    for (f in a) {
                        var l = a[f], A = l && l.requires;
                        if (!d[f]) {
                            if (l.icons)for (var r = l.icons.split(","), D = r.length; D--;)CKEDITOR.skin.addIcon(r[D], l.path + "icons/" + (CKEDITOR.env.hidpi && l.hidpi ? "hidpi/" : "") + r[D] + ".png");
                            d[f] = 1
                        }
                        if (A)for (A.split && (A = A.split(",")), l = 0; l < A.length; l++)g[A[l]] || b.push(A[l])
                    }
    ...
    (function () {
        ...
        function y(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var f in c) {
                    var g = c[f], t = g.lang, k = null, l = g.requires, q;
                    CKEDITOR.tools.isArray(l) && (l = l.join(","));
                    if (l && (q = l.match(p)))for (; l = q.pop();)CKEDITOR.error("editor-plugin-required",
                        {plugin: l.replace(",", ""), requiredBy: f});
                    t && !a.lang[f] && (t.split && (t = t.split(",")), 0 <= CKEDITOR.tools.indexOf(t, a.langCode) ? k = a.langCode : (k = a.langCode.replace(/-.*/, ""), k = k != a.langCode && 0 <= CKEDITOR.tools.indexOf(t, k) ? k : 0 <= CKEDITOR.tools.indexOf(t, "en") ? "en" : t[0]), g.langEntries && g.langEntries[k] ? (a.lang[f] = g.langEntries[k], k = null) : e.push(CKEDITOR.getUrl(g.path + "lang/" + k + ".js")));
                    h.push(k);
                    d.push(g)
                }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            addCommand: function (a, b) {
                ...
                for (var d = new CKEDITOR.dom.documentFragment, e, h, p, m = 0; m < c.length; m++) {
                    var f = c[m], g = f.startContainer;
                    g.getName && "tr" == g.getName() ? (e || (e = g.getAscendant("table").clone(), e.append(g.getAscendant("tbody").clone()), d.append(e), e = e.findOne("tbody")), h && h.equals(g) || (h = g, p = g.clone(), e.append(p)), p.append(f.cloneContents())) : d.append(f.cloneContents())
                }
        ...
        CKEDITOR.htmlParser.prototype = {
            onTagOpen: function () {
                ...
                for (var c, e, g = 0, k; c = this._.htmlPartsRegex.exec(b);) {
                    e = c.index;
                    if (e > g)if (g = b.substring(g, e), k)k.push(g); else this.onText(g);
                    g = this._.htmlPartsRegex.lastIndex;
                    if (e = c[1])if (e = e.toLowerCase(), k && CKEDITOR.dtd.$cdata[e] && (this.onCDATA(k.join("")), k = null), !k) {
                        this.onTagClose(e);
                        continue
                    }
                    if (k)k.push(c[0]); else if (e = c[3]) {
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (g, k, l) {
                function q(a) {
                    var b;
                    if (0 < w.length)for (var c = 0; c < w.length; c++) {
                        var d = w[c], h = d.name, e = CKEDITOR.dtd[h], f = u.name && CKEDITOR.dtd[u.name];
                        f && !f[h] || a && e && !e[a] && CKEDITOR.dtd[a] ? h == u.name && (y(u, u.parent, 1), c--) : (b || (v(), b = 1), d = d.clone(), d.parent = u, u = d, w.splice(c, 1), c--)
                    }
                }

                function v() {
                    for (; H.length;)y(H.shift(), u)
                }
                ...
                function y(b, c, d) {
                    c = c || u || n;
                    var e = u;
                    void 0 === b.previous && (A(c, b) && (u = c, D.onTagOpen(l, {}), b.returnPoint = c = u), f(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (h = !1), "textarea" == b.name && (t = !1));
                    b.returnPoint ? (u = b.returnPoint, delete b.returnPoint) : u = d ? c : e
                }

                function A(a, b) {
                    if ((a == n || "body" == a.name) && l && (!a.name || CKEDITOR.dtd[a.name][l])) {
                        var c, d;
                ...
                var D = new CKEDITOR.htmlParser, n = k instanceof CKEDITOR.htmlParser.element ? k : "string" == typeof k ? new CKEDITOR.htmlParser.element(k) : new CKEDITOR.htmlParser.fragment, w = [], H = [], u = n, t = "textarea" == n.name, h = "pre" == n.name;
                D.onTagOpen = function (e, m, f, g) {
                    m = new CKEDITOR.htmlParser.element(e, m);
                    m.isUnknown && f && (m.isEmpty = !0);
                    m.isOptionalClose = g;
                    if (a(m))w.push(m); else {
                        if ("pre" == e)h = !0; else {
                            if ("br" == e && h) {
                        ...
                        if ("br" == e)H.push(m); else {
                            for (; !(g = (f = u.name) ? CKEDITOR.dtd[f] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, m.isUnknown || u.isUnknown || g[e]);)if (u.isOptionalClose)D.onTagClose(f); else if (e in b && f in b)f = u.children, (f = f[f.length - 1]) && "li" == f.name || y(f = new CKEDITOR.htmlParser.element("li"), u), !m.returnPoint && (m.returnPoint = u), u = f; else if (e in CKEDITOR.dtd.$listItem && !r(e, f))D.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (f in d && !r(e, f))!m.returnPoint && (m.returnPoint = u), u = u.parent; else if (f in CKEDITOR.dtd.$inline && w.unshift(u), u.parent)y(u, u.parent, 1); else {
                                m.isOrphan = 1;
                                break
                            }
                            q(e);
                ...
                D.onTagClose = function (a) {
                    for (var b = w.length - 1; 0 <= b; b--)if (a == w[b].name) {
                        w.splice(b, 1);
                        return
                    }
                    for (var c = [], d = [], h = u; h != n && h.name != a;)h._.isBlockLike || d.unshift(h), c.push(h), h = h.returnPoint || h.parent;
                    if (h != n) {
                ...
                D.onText = function (a) {
                    if (!(u._.hasInlineStarted && !H.length || h || t) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length))return;
                    var b = u.name, f = b ? CKEDITOR.dtd[b] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                    if (!t && !f["#"] && b in d)D.onTagOpen(e[b] || ""), D.onText(a); else {
                        v();
                        q();
                        h || t || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                        a = new CKEDITOR.htmlParser.text(a);
                        if (A(u, a))this.onTagOpen(l, {}, 0, 1);
                        u.add(a)
                    }
                };
                D.onCDATA =
    ...
    (function () {
        ...
        function d(b, c, d, g) {
            var k, l;
            for (k in c)(l = b[k]) || (l = b[k] = new a), l.add(c[k], d, g)
        }
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            $: function (b) {
                ...
                addRules: function (a, c) {
                    ...
                    for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], g, k = 0; 3 > k; k++)if (g = d[k]) {
                        g = g.exec(a, c, this);
                        if (!1 === g)return null;
        ...
        a.prototype = {
            add: function (a, c, d) {
                this.rules.splice(this.findIndex(c), 0, {value: a, priority: c, options: d})
                                  ...
                                  c, d) {
                for (var g = [this.findIndex(c), 0], k = 0, l = a.length; k < l; k++)g.push({
                    value: a[k],
                    priority: c,
                    options: d
                });
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, g = Array.prototype.slice.call(arguments, 1), k = this.rules, l = k.length, q, v, f, y;
                for (y = 0; y < l; y++)if (d && (q = c.type, v = c.name), f = k[y], !(a.nonEditable && !f.options.applyToAll ||
                    a.nestedEditable && f.options.excludeNestedEditable)) {
                    f = f.value.apply(null, g);
                    if (!1 === f || d && f && (f.name != v || f.type != q))return f;
                    null != f && (g[0] = c = f)
                }
                return c
            }, execOnName: function (a, c) {
                for (var d = 0, g = this.rules, k = g.length, l; c && d < k; d++)l = g[d], a.nonEditable && !l.options.applyToAll || a.nestedEditable && l.options.excludeNestedEditable || (c = c.replace(l.value[0], l.value[1]));
                return c
            }
        }
    })();
    (function () {
        function a(a, d) {
            ...
            function m(a, d) {
                return function (h) {
                    if (h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var e = [], m = b(h), t, G;
                        if (m)for (p(m, 1) && e.push(m); m;)g(m) && (t = c(m)) && p(t) && ((G = c(t)) && !g(G) ? e.push(t) : (f(x).insertAfter(t), t.remove())), m = m.previous;
                        for (m = 0; m < e.length; m++)e[m].remove();
                        if (e = !a || !1 !== ("function" == typeof d ? d(h) : d))x || CKEDITOR.env.needsBrFiller ||
                        h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? x || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || h.name in CKEDITOR.dtd.tr || h.name in CKEDITOR.dtd.$listItem) ? (e = b(h), e = !e || "form" == h.name && "input" == e.name) : e = !1 : e = !1;
                        e && h.add(f(a))
                    }
                }
            }
            ...
            function p(a, b) {
                ...
                return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(w)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a),
                    a.value = c[0]), !CKEDITOR.env.needsBrFiller && x && (!b || a.parent.name in F) || !x && ((c = a.previous) && "br" == c.name || !c || g(c))) ? !0 : !1
            }

            var t = {elements: {}}, x = "html" == d, F = CKEDITOR.tools.extend({}, h), C;
            for (C in F)"#" in u[C] || delete F[C];
            for (C in F)t.elements[C] = m(x, a.config.fillEmptyBlocks);
            t.root = m(x, !1);
                    ...
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus" in d || "data-cke-eol" in d)delete d["data-cke-bogus"]; else {
                            for (d = b.next; d && e(d);)d =
                                d.next;
                            var h = c(b);
                            !d && g(b.parent) ? k(b.parent, f(a)) : g(d) && h && !g(h) && f(a).insertBefore(d)
                        }
                    }
                }
            }(x);
        ...
        function n(a, b) {
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, h) {
                return "\x3c" + c + d + "\x3e" + D(r(h), b) + "\x3c/" + c + "\x3e"
            })
        }
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            h.addRules(x);
            h.addRules(z, {applyToAll: !0});
            h.addRules(a(b, "html"), {applyToAll: !0});
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, h, c = n(c, b), c = f(c, P), c = v(c), c = f(c, Y), c = c.replace(N, "$1cke:$2"), c = c.replace(I, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                var h = this.editor, e, m, f, p;
                b && "object" == typeof b ? (e = b.context, c = b.fixForBody, d = b.dontFilter, m = b.filter, f = b.enterMode, p = b.protectedWhitespaces) : e = b;
                e || null === e || (e = h.editable().getName());
                return h.fire("toHtml", {
                    dataValue: a, context: e, fixForBody: c, dontFilter: d,
                    filter: m || h.filter, enterMode: f || h.enterMode, protectedWhitespaces: p
                }).dataValue
        ...
        var w = /(?:&nbsp;|\xa0)$/, H = "{cke_protected}", u = CKEDITOR.dtd, t = "caption colgroup col thead tfoot tbody".split(" "), h = CKEDITOR.tools.extend({}, u.$blockLimit,
            u.$block), p = {
            elements: {
                input: l,
                textarea: l
            }
        }, m = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, x = {
            elements: {
                embed: function (a) {
                    var b = a.parent;
                    if (b && "object" == b.name) {
            ...
            elementNames: [[/^cke:/, ""], [/^\?xml:namespace$/, ""]], attributeNames: [[/^data-cke-(saved|pa)-/,
                ...
                $: function (a) {
                    ...
                    a.children.slice(0).sort(function (a, b) {
                        var c, d;
                        a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(t, a.name), d = CKEDITOR.tools.indexOf(t, b.name));
        ...
        var F = /<(a|area|img|input|source)\b([^>]*)>/gi, B = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, E = /^(href|src|name)$/i, Y = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            P = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, O = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, N = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi, C = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, I = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                for (; ;) {
                    k = d.name;
                    if (!(l = a.onElementName(b, k)))return this.remove(), !1;
                    d.name = l;
                ...
                var q, v;
                for (q in k) {
                    for (l = k[q]; ;)if (v = a.onAttributeName(b, q))if (v != q)delete k[q], q = v; else break; else {
                        delete k[q];
                        break
                    }
                    v && (!1 === (l = a.onAttribute(b, d, v, l)) ? delete k[v] :
                        k[v] = l)
                }
                ...
                b && this.filter(b);
                var g = this.name, k = [], l = this.attributes, q, v;
                a.openTag(g, l);
                for (q in l)k.push([q, l[q]]);
                a.sortAttributes && k.sort(d);
                q = 0;
                for (v = k.length; q < v; q++)l = k[q], a.attribute(l[0], l[1]);
    ...
    (function () {
        function a(a, e, g, k) {
            ...
            a = CKEDITOR.dom.element.get(a);
            if (a.getEditor())throw'The editor instance "' + a.getEditor().name + '" is already attached to the provided element.';
            var l = new CKEDITOR.editor(e, a, k);
            k == CKEDITOR.ELEMENT_MODE_REPLACE && (a.setStyle("visibility", "hidden"), l._.required = a.hasAttribute("required"), a.removeAttribute("required"));
            g && l.setData(g, null, !0);
            l.on("loaded", function () {
                b(l);
                k == CKEDITOR.ELEMENT_MODE_REPLACE && l.config.autoUpdateElement &&
        ...
        function b(a) {
            var b = a.name, d = a.element, k = a.elementMode, l =
                    ...
                    space: "bottom",
                    html: ""
                }).html, v = new CKEDITOR.template('\x3c{outerEl} id\x3d"cke_{name}" class\x3d"{id} cke cke_reset cke_chrome cke_editor_{name} cke_{langDir} ' + CKEDITOR.env.cssClass + '"  dir\x3d"{langDir}" lang\x3d"{langCode}" role\x3d"application"' + (a.title ? ' aria-labelledby\x3d"cke_{name}_arialbl"' : "") + "\x3e" + (a.title ? '\x3cspan id\x3d"cke_{name}_arialbl" class\x3d"cke_voice_label"\x3e{voiceLabel}\x3c/span\x3e' : "") + '\x3c{outerEl} class\x3d"cke_inner cke_reset" role\x3d"presentation"\x3e{topHtml}\x3c{outerEl} id\x3d"{contentId}" class\x3d"cke_contents cke_reset" role\x3d"presentation"\x3e\x3c/{outerEl}\x3e{bottomHtml}\x3c/{outerEl}\x3e\x3c/{outerEl}\x3e'),
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            ...
            if (a != d.mode && k && k[a]) {
                ...
                if (d.mode) {
                    var l = d.checkDirty(), k = d._.previousModeData, q, v = 0;
                    d.fire("beforeModeUnload");
                    d.editable(0);
                    d._.previousMode = d.mode;
                    d._.previousModeData = q = d.getData(1);
                    "source" == d.mode && k == q && (d.fire("lockSnapshot", {forceUpdate: !0}), v = 1);
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, k) {
            var l = this.container, q = this.ui.space("contents"), v = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement;
            k = k ? this.container.getFirst(function (a) {
                return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner")
            }) : l;
            k.setSize("width", a, !0);
            v && (v.style.width = "1%");
            var f = (k.$.offsetHeight || 0) - (q.$.clientHeight ||
                0), l = Math.max(b - (d ? 0 : f), 0);
            b = d ? b + f : b;
            q.setStyle("height", l + "px");
            v && (v.style.width = "100%");
            this.fire("resize", {outerHeight: b, contentsHeight: l, outerWidth: a || k.getSize("width")})
        };
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, m = e.blockLimit, f = a.data.selection, g = f.getRanges()[0], F;
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)if (f = d(f, e))f.appendBogus(), F = CKEDITOR.env.ie;
            k(b, e.block, m) && g.collapsed && !g.getCommonAncestor().isReadOnly() && (e = g.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), m = new CKEDITOR.dom.walker(e), m.guard = function (a) {
                return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly()
            }, !m.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) &&
            (b = g.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), F = 1, a.cancel());
            F && g.select()
        }
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                on: function (a, b) {
                    ...
                    var g, k;
                    if (f)for (; (g = b.getCommonAncestor(0, 1)) && (k = CKEDITOR.dtd[g.getName()]) &&
                                 (!k || !k[e]);)g.getName() in CKEDITOR.dtd.span ? b.splitElement(g) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(g), b.collapse(!0), g.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                    b.insertNode(a);
                    return !0
                ...
                extractHtmlFromRange: function (a, b) {
                    var c = u, d = {range: a, doc: a.document}, e = this.getHtmlFromRange(a);
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (m) {
                            var e = d.getHead(), k = e.getCustomData("stylesheet");
                            k ? m != k.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? k.$.styleSheet.cssText = m : k.setText(m)) : (m = d.appendStyleText(m), m = new CKEDITOR.dom.element(m.ownerNode || m.owningElement), e.setCustomData("stylesheet", m), m.data("cke-temp", 1))
                        }
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in l) {
                                b = a.getSelection();
                                var h, e = b.getRanges()[0], m = e.startPath(), p, k, x, c = 8 == c;
                                ...
                                (x = k[c ? "getPrevious" : "getNext"](f)) ? (a.fire("saveSnapshot"), e["moveToElementEdit" + (c ? "End" : "Start")](x), e.checkStartOfBlock() && e.checkEndOfBlock() ? x.remove() : e.select(), a.fire("saveSnapshot"), d = 1) : (k = m.contains(["td", "th", "caption"])) && e.checkBoundaryOfElement(k, c ? CKEDITOR.START : CKEDITOR.END) && (d = 1))
                            }
                            return !d
                        });
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup", function (b) {
                            b.data.getKeystroke() in l && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this,
                            ...
                            if (b in l) {
                                ...
                                if (d.collapsed)a:{
                                    ...
                                    if (h && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(h, !c) && d.collapsed) {
                                        ...
                                        d = d.startPath().block;
                                        if (!d || d && d.contains(h))b = void 0; else {
                                            a.fire("saveSnapshot");
                                            var f;
                                    ...
                                    c.deleteContents(), d.getParent() && (d.moveChildren(f, !1), b.lastElement.mergeSiblings(), v(f, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
                                if (!b)return;
            ...
            b.on("mode", function () {
                ...
                if (a && a.isInline()) {
                    ...
                    if (d && (c = this.ui.space(this.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? "top" : "contents"))) {
                        var e = CKEDITOR.tools.getNextId(), d = CKEDITOR.dom.element.createFromHtml('\x3cspan id\x3d"' + e + '" class\x3d"cke_voice_label"\x3e' +
                            d + "\x3c/span\x3e");
                        c.append(d);
        ...
        n = function () {
            ...
            function b(c, d) {
                var e, f, m, p, g = [], k = d.range.startContainer;
                e = d.range.startPath();
                for (var k = B[k.getName()], x = 0, l = c.getChildren(), F = l.count(), z = -1, n = -1, q = 0, v = e.contains(B.$list); x < F; ++x)e = l.getItem(x), a(e) ? (m = e.getName(), v && m in CKEDITOR.dtd.$list ? g = g.concat(b(e, d)) : (p = !!k[m], "br" != m || !e.data("cke-eol") || x && x != F - 1 || (q = (f = x ? g[x - 1].node : l.getItem(x + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && B.$block[f.getName()]), -1 != z || p || (z = x), p || (n = x), g.push({
                    isElement: 1, isLineBreak: q, isBlock: e.isBlockBoundary(),
                    hasBlockSibling: f, node: e, name: m, allowed: p
                }), f = q = 0)) : g.push({isElement: 0, node: e, allowed: 1});
                -1 < z && (g[z].firstNotAllowed = 1);
                -1 < n && (g[n].lastNotAllowed = 1);
                return g
            }

            function d(b, c) {
                var e = [], h = b.getChildren(), f = h.count(), m, g = 0, k = B[c], x = !b.is(B.$inline) || b.is("br");
                for (x && e.push(" "); g < f; g++)m = h.getItem(g), a(m) && !m.is(k) ? e = e.concat(d(m, c)) : e.push(m);
                x && e.push(" ");
                return e
            }
            ...
            function f(b) {
                return b && a(b) && (b.is(B.$removeEmpty) ||
            ...
            function g(b, c, d, e) {
                ...
                (f = (new CKEDITOR.dom.walker(h)).next()) && a(f) && n[f.getName()] && (m = f.getPrevious()) && a(m) && !m.getParent().equals(b.startContainer) && d.contains(m) && e.contains(f) && f.isIdentical(m) && (f.moveChildren(m), f.remove(), g(b, c, d, e))
            }
            ...
            function F(b, c) {
                ...
                var e = c.endContainer.getChild(c.endOffset), h = c.endContainer.getChild(c.endOffset -
                    1);
                e && d(e, b[b.length - 1]);
            ...
            var B = CKEDITOR.dtd, n = {
                ...
                dl: 1,
                blockquote: 1
            }, q = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, v = CKEDITOR.tools.extend({}, B.$inline);
            delete v.br;
            return function (n, E, C, I) {
                var G = n.editor, K = !1;
                "unfiltered_html" == E && (E = "html", K = !0);
                if (!I.checkReadOnly()) {
                    var J = (new CKEDITOR.dom.elementPath(I.startContainer, I.root)).blockLimit || I.root;
                    n = {
                        type: E, dontFilter: K, editable: n,
                        editor: G, range: I, blockLimit: J, mergeCandidates: [], zombies: []
                    };
                    E = n.range;
                    I = n.mergeCandidates;
                    var L, r;
                    "text" == n.type && E.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (L = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", E.document), E.insertNode(L), E.setStartAfter(L));
                    K = new CKEDITOR.dom.elementPath(E.startContainer);
                    n.endPath = J = new CKEDITOR.dom.elementPath(E.endContainer);
                    if (!E.collapsed) {
                        var G = J.block || J.blockLimit, w = E.getCommonAncestor();
                        G && !G.equals(w) && !G.contains(w) && E.checkEndOfBlock() &&
                        n.zombies.push(G);
                        E.deleteContents()
                    }
                    for (; (r = e(E)) && a(r) && r.isBlockBoundary() && K.contains(r);)E.moveToPosition(r, CKEDITOR.POSITION_BEFORE_END);
                    g(E, n.blockLimit, K, J);
                    L && (E.setEndBefore(L), E.collapse(), L.remove());
                    L = E.startPath();
                    if (G = L.contains(f, !1, 1))E.splitElement(G), n.inlineStylesRoot = G, n.inlineStylesPeak = L.lastElement;
                    L = E.createBookmark();
                    (G = L.startNode.getPrevious(c)) && a(G) && f(G) && I.push(G);
                    (G = L.startNode.getNext(c)) && a(G) && f(G) && I.push(G);
                    for (G = L.startNode; (G = G.getParent()) && f(G);)I.push(G);
                    E.moveToBookmark(L);
                    if (L = C) {
                        L = n.range;
                        if ("text" == n.type && n.inlineStylesRoot) {
                            r = n.inlineStylesPeak;
                            E = r.getDocument().createText("{cke-peak}");
                            for (I = n.inlineStylesRoot.getParent(); !r.equals(I);)E = E.appendTo(r.clone()), r = r.getParent();
                            C = E.getOuterHtml().split("{cke-peak}").join(C)
                        }
                        r = n.blockLimit.getName();
                        if (/^\s+|\s+$/.test(C) && "span" in CKEDITOR.dtd[r]) {
                            var A = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
                            C = A + C + A
                        }
                        C = n.editor.dataProcessor.toHtml(C, {
                            context: null, fixForBody: !1, protectedWhitespaces: !!A,
                            dontFilter: n.dontFilter, filter: n.editor.activeFilter, enterMode: n.editor.activeEnterMode
                        });
                        r = L.document.createElement("body");
                        r.setHtml(C);
                        A && (r.getFirst().remove(), r.getLast().remove());
                        if ((A = L.startPath().block) && (1 != A.getChildCount() || !A.getBogus()))a:{
                            var y;
                            if (1 == r.getChildCount() && a(y = r.getFirst()) && y.is(q) && !y.hasAttribute("contenteditable")) {
                                A = y.getElementsByTag("*");
                                L = 0;
                                for (I = A.count(); L < I; L++)if (E = A.getItem(L), !E.is(v))break a;
                    ...
                    if (L) {
                        ...
                        var R, W;
                        E = y.startContainer;
                        var K = n.endPath.elements[0], X, J = K.getPosition(E), w = !!K.getCommonAncestor(E) && J != CKEDITOR.POSITION_IDENTICAL && !(J & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        E = b(n.dataWrapper, n);
                        for (F(E, y); I < E.length; I++) {
                            J = E[I];
                            if (u = J.isLineBreak) {
                                u = y;
                                R = r;
                                var T = void 0, aa = void 0;
                                J.hasBlockSibling ? u = 1 : (T = u.startContainer.getAscendant(B.$block, 1)) && T.is({
                                    div: 1,
                                    p: 1
                                }) ? (aa = T.getPosition(R), aa == CKEDITOR.POSITION_IDENTICAL ||
                                aa == CKEDITOR.POSITION_CONTAINS ? u = 0 : (R = u.splitElement(T), u.moveToPosition(R, CKEDITOR.POSITION_AFTER_START), u = 1)) : u = 0
                            }
                            if (u)C = 0 < I; else {
                                u = y.startPath();
                                !J.isBlock && k(n.editor, u.block, u.blockLimit) && (H = l(n.editor)) && (H = L.createElement(H), H.appendBogus(), y.insertNode(H), CKEDITOR.env.needsBrFiller && (D = H.getBogus()) && D.remove(), y.moveToPosition(H, CKEDITOR.POSITION_BEFORE_END));
                                if ((u = y.startPath().block) && !u.equals(M)) {
                                    if (D = u.getBogus())D.remove(), A.push(u);
                                    M = u
                                }
                                J.firstNotAllowed && (G = 1);
                                if (G && J.isElement) {
                                    u =
                                        y.startContainer;
                                    for (R = null; u && !B[u.getName()][J.name];) {
                                        if (u.equals(r)) {
                                            u = null;
                                            break
                                        }
                                    ...
                                    if (u)R && (W = y.splitElement(R), n.zombies.push(W), n.zombies.push(R)); else {
                                        R = r.getName();
                                        X = !I;
                                        u = I == E.length - 1;
                                        R = d(J.node, R);
                                        for (var T = [], aa = R.length, ba = 0, da = void 0, ea = 0, ga = -1; ba < aa; ba++)da = R[ba], " " == da ? (ea || X && !ba || (T.push(new CKEDITOR.dom.text(" ")), ga = T.length), ea = 1) : (T.push(da), ea = 0);
                                        u && ga == T.length && T.pop();
                                        X = T
                                    }
                                }
                                if (X) {
                                    ...
                                    X = 0
                                } else y.insertNode(J.node);
                                J.lastNotAllowed &&
                                I < E.length - 1 && ((W = w ? K : W) && y.setEndAt(W, CKEDITOR.POSITION_AFTER_START), G = 0);
                                y.collapse()
                            }
                        }
                        1 != E.length ? D = !1 : (D = E[0], D = D.isElement && "false" == D.node.getAttribute("contenteditable"));
                        D && (C = !0, u = E[0].node, y.setStartAt(u, CKEDITOR.POSITION_BEFORE_START), y.setEndAt(u, CKEDITOR.POSITION_AFTER_END));
                        n.dontMoveCaret = C;
                    ...
                    for (X = D.createBookmark(); M = n.zombies.pop();)M.getParent() && (H = D.clone(), H.moveToElementEditStart(M), H.removeEmptyBlocksAtEnd());
                    if (W)for (; M =
                                     W.pop();)CKEDITOR.env.needsBrFiller ? M.appendBogus() : M.append(D.document.createText(" "));
                    for (; M = n.mergeCandidates.pop();)M.mergeSiblings();
                    D.moveToBookmark(X);
                    if (!n.dontMoveCaret) {
                        for (M = e(D); M && a(M) && !M.is(B.$empty);) {
                            if (M.isBlockBoundary())D.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END); else {
                                if (f(M) && M.getHtml().match(/(\s|&nbsp;)$/g)) {
                                    S = null;
                                    break
                                }
                                S = D.clone();
                                S.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END)
                            }
                            M = M.getLast(c)
                        }
                        S && D.moveToRange(S)
        ...
        H = {
            eol: {
                detect: function (a, b) {
                    var c = a.range, d = c.clone(), e = c.clone(), f = new CKEDITOR.dom.elementPath(c.startContainer, b), g = new CKEDITOR.dom.elementPath(c.endContainer, b);
                    d.collapse(1);
                    e.collapse();
            ...
            return {
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b, a.bookmark), e = d.startPath(), f = d.endPath(), h = e.contains(CKEDITOR.dtd.$list), g = f.contains(CKEDITOR.dtd.$list);
                        ...
                        if (a.mergeListBookmark) {
                            var d = a.mergeListBookmark.startNode, e = a.mergeListBookmark.endNode, f = new CKEDITOR.dom.elementPath(d, c), g = new CKEDITOR.dom.elementPath(e, c);
                            if (a.mergeList) {
                                var p = f.contains(CKEDITOR.dtd.$list), k = g.contains(CKEDITOR.dtd.$list);
                                p.equals(k) || (k.moveChildren(p), k.remove())
                            }
                    ...
                    function a(c) {
                        var e = [], f, h = new CKEDITOR.dom.walker(c), g = c.startPath().contains(d), m = c.endPath().contains(d), p = {};
                        h.guard = function (a, h) {
                            if (a.type == CKEDITOR.NODE_ELEMENT) {
                                var k = "visited_" + (h ? "out" : "in");
                                if (a.getCustomData(k))return;
                                CKEDITOR.dom.element.setMarker(p, a, k, 1)
                            }
                            if (h && g && a.equals(g))f = c.clone(), f.setEndAt(g, CKEDITOR.POSITION_BEFORE_END), e.push(f); else if (!h && m && a.equals(m))f = c.clone(), f.setStartAt(m, CKEDITOR.POSITION_AFTER_START), e.push(f);
                            else {
                                if (k = !h)k = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!g || b(a, g)) && (!m || b(a, m));
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var h = c(f, e.bookmark), g = h.clone(), k, l, n = h.getCommonAncestor();
                            n.is(CKEDITOR.dtd.$tableContent) && !n.is(d) && (n = n.getAscendant("table",
                                !0));
                            l = n;
                            n = new CKEDITOR.dom.elementPath(h.startContainer, l);
                            l = new CKEDITOR.dom.elementPath(h.endContainer, l);
                            n = n.contains("table");
                            l = l.contains("table");
                            if (n || l)n && l && b(n, l) ? (e.tableSurroundingRange = g, g.setStartAt(n, CKEDITOR.POSITION_AFTER_END), g.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), g = h.clone(), g.setEndAt(n, CKEDITOR.POSITION_AFTER_END), k = h.clone(), k.setStartAt(l, CKEDITOR.POSITION_BEFORE_START), k = a(g).concat(a(k))) : n ? l || (e.tableSurroundingRange = g, g.setStartAt(n, CKEDITOR.POSITION_AFTER_END), h.setEndAt(n,
                    ...
                    var c = b.startPath(), d;
                    k(a, c.block, c.blockLimit) && (d = l(a)) && (d = b.document.createElement(d), d.appendBogus(),
    ...
    (function () {
        ...
        function c(a) {
            return r(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1
        }
        ...
        function k(a, b) {
            ...
            if (c) {
                if (!1 !== b) {
                    var d = a.getDocument().getSelection().getNative(), e = d && "None" != d.type && d.getRangeAt(0), f = u.length;
        ...
        function l(a, b) {
            return b ? a.replace(t, function (a, b) {
                return b ? " " : ""
            }) : a.replace(u, "")
        }

        function q(a, b) {
            var c = CKEDITOR.dom.element.createFromHtml('\x3cdiv data-cke-hidden-sel\x3d"1" data-cke-temp\x3d"1" style\x3d"' + (CKEDITOR.env.ie ? "display:none" : "position:fixed;top:0;left:-1000px") +
        ...
        function f(a) {
            for (var b = 0; b < a.length; b++) {
                ...
                if (!c.collapsed) {
                    ...
                    d = c.startContainer;
                    e = c.endContainer;
                    var f = c.startOffset, g = c.endOffset, k = c.clone();
                    d && d.type == CKEDITOR.NODE_TEXT && (f >= d.getLength() ? k.setStartAfter(d) : k.setStartBefore(d));
                    e && e.type == CKEDITOR.NODE_TEXT && (g ? k.setEndAfter(e) : k.setEndBefore(e));
        ...
        var y, A, r = CKEDITOR.dom.walker.invisible(1), D = function () {
            function a(b) {
                return function (a) {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                ...
                var f = e.document, h = CKEDITOR.document, g = e.editable(), p = f.getBody(), l = f.getDocumentElement(), q = g.isInline(), r, C;
                CKEDITOR.env.gecko && g.attachListener(g, "focus", function (a) {
                    a.removeListener();
                    0 !== r && (a = e.getSelection().getNative()) && a.isCollapsed && a.anchorNode == g.$ && (a = e.createRange(), a.moveToElementEditStart(g), a.select())
                }, null, null, -2);
                g.attachListener(g,
                    CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () {
                        r && CKEDITOR.env.webkit && (r = e._.previousActive && e._.previousActive.equals(f.getActive()));
                        e.unlockSelection(r);
                        r = 0
                    }, null, null, -1);
                ...
                if (CKEDITOR.env.ie || q)n ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function () {
                    e.lockSelection(C);
                    r = 1
                ...
                if (CKEDITOR.env.ie && !q) {
                    ...
                    if ("BackCompat" != f.$.compatMode) {
                        ...
                        if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version)l.on("mousedown", function (a) {
                            a.data.getTarget().is("html") && (h.on("mouseup", c), l.on("mouseup", c))
                        })
                    }
                }
                ...
                g.attachListener(g, "keydown", v(e), null, null, -1)
            });
        ...
        if (CKEDITOR.env.webkit)CKEDITOR.on("instanceReady", function (a) {
            ...
            b.on("getSnapshot", function (a) {
                a.data && (a.data = l(a.data))
            }, b, null, 20);
            b.on("toDataFormat",
                function (a) {
                    a.data.dataValue = l(a.data.dataValue)
                }, null, null, 0)
        });
        ...
        var n = "function" != typeof window.getSelection, w = 1;
        ...
        var H = {
            ...
            thead: 1,
            tfoot: 1
        }, u = CKEDITOR.tools.repeat("​", 7), t = new RegExp(u + "( )?", "g");
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                ...
                if (!c || !c.rangeCount)b = CKEDITOR.SELECTION_NONE; else if (1 == c.rangeCount) {
                    ...
                    d == c.endContainer && 1 == d.nodeType && 1 == c.endOffset - c.startOffset && H[d.childNodes[c.startOffset].nodeName.toLowerCase()] && (b = CKEDITOR.SELECTION_ELEMENT)
                }
                return a.type = b
            }, getRanges: function () {
                var a = n ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, h, g = b.duplicate(), k = 0, l = e.length - 1, C = -1, m, n; k <= l;)if (C = Math.floor((k + l) / 2), f = e[C], g.moveToElementText(f), m = g.compareEndPoints("StartToStart", b), 0 < m)l = C - 1; else if (0 > m)k = C + 1; else return {
                            container: d,
                            offset: a(f)
                        };
                        if (-1 == C || C == e.length - 1 && 0 > m) {
                            ...
                            for (d = e.length; 0 < g && 0 < d;)h = e[--d], h.nodeType == CKEDITOR.NODE_TEXT && (n = h, g -= h.nodeValue.length);
                            return {container: n, offset: -g}
                        }
                        g.collapse(0 < m ? !0 : !1);
                        g.setEndPoint(0 < m ? "StartToStart" : "EndToStart", b);
                        g = g.text.replace(/(\r\n|\r)/g, "\n").length;
                        if (!g)return {container: d, offset: a(f) + (0 < m ? 0 : 1)};
                        for (; 0 < g;)try {
                            h = f[0 < m ? "previousSibling" : "nextSibling"], h.nodeType == CKEDITOR.NODE_TEXT && (g -= h.nodeValue.length, n = h), f = h
                        } catch (K) {
                            return {container: d, offset: a(f)}
                        }
                        return {container: n, offset: 0 < m ? -g : n.nodeValue.length + g}
                    };
                    return function () {
                ...
                var b = this, c = CKEDITOR.tools.tryThese(function () {
                    ...
                    for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && H[c.getName()] && (d = c)); e--)a.shrink(CKEDITOR.SHRINK_ELEMENT);
                    return d && d.$
                });
                ...
                var b = this.getNative(), b = n ? "Control" == b.type ? "" : b.createRange().text :
                    b.toString();
                ...
                if (a.length)if (this.isLocked) {
                    ...
                    a:{
                        var q, v;
                        if (1 == a.length && !(v = a[0]).collapsed && (l = v.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (v = v.clone(), v.shrink(CKEDITOR.SHRINK_ELEMENT,
                                !0), (q = v.getEnclosedNode()) && q.type == CKEDITOR.NODE_ELEMENT && (l = q), "false" == l.getAttribute("contenteditable")))break a;
                        l = void 0
                    }
                    if (l)this.fake(l); else {
                        if (n) {
                            ...
                            1 < a.length && (l = a[a.length - 1], a[0].setEnd(l.endContainer, l.endOffset));
                            l = a[0];
                            a = l.collapsed;
                            var r, u, t;
                            if ((c = l.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in H && (!c.is("a") || !c.getText()))try {
                                t = c.$.createControlRange();
                                t.addElement(c.$);
                                t.select();
                                return
                            } catch (y) {
                            }
                            if (l.startContainer.type == CKEDITOR.NODE_ELEMENT && l.startContainer.getName() in b || l.endContainer.type == CKEDITOR.NODE_ELEMENT && l.endContainer.getName() in b)l.shrink(CKEDITOR.NODE_ELEMENT, !0), a = l.collapsed;
                            t = l.createBookmark();
                            b = t.startNode;
                            a || (f = t.endNode);
                            t = l.document.$.body.createTextRange();
                            t.moveToElementText(b.$);
                            t.moveStart("character", 1);
                            f ? (q = l.document.$.body.createTextRange(), q.moveToElementText(f.$), t.setEndPoint("EndToEnd", q), t.moveEnd("character", -1)) : (r = b.getNext(v), u =
                                b.hasAscendant("pre"), r = !(r && r.getText && r.getText().match(q)) && (u || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")), u = l.document.createElement("span"), u.setHtml("\x26#65279;"), u.insertBefore(b), r && l.document.createText("﻿").insertBefore(b));
                            l.setStartBefore(b);
                            b.remove();
                            a ? (r ? (t.moveStart("character", -1), t.select(), l.document.$.selection.clear()) : t.select(), l.moveToPosition(u, CKEDITOR.POSITION_BEFORE_START), u.remove()) : (l.setEndBefore(f), f.remove(), t.select())
                        } else {
                            f = this.getNative();
                            if (!f)return;
                            this.removeAllRanges();
                            for (t = 0; t < a.length; t++) {
                                if (t < a.length - 1 && (r = a[t], u = a[t + 1], q = r.clone(), q.setStart(r.endContainer, r.endOffset), q.setEnd(u.startContainer, u.startOffset), !q.collapsed && (q.shrink(CKEDITOR.NODE_ELEMENT, !0), l = q.getCommonAncestor(), q = q.getEnclosedNode(), l.isReadOnly() || q && q.isReadOnly()))) {
                                ...
                                l.collapsed && CKEDITOR.env.webkit && e(l) && (q = g(this.root), l.insertNode(q), (r =
                                    q.getNext()) && !q.getPrevious() && r.type == CKEDITOR.NODE_ELEMENT && "br" == r.getName() ? (k(this.root), l.moveToPosition(r, CKEDITOR.POSITION_BEFORE_START)) : l.moveToPosition(q, CKEDITOR.POSITION_AFTER_END));
                                u.setStart(l.startContainer.$, l.startOffset);
                                try {
                                    u.setEnd(l.endContainer.$, l.endOffset)
                                } catch (C) {
                                    if (0 <= C.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))l.collapse(1), u.setEnd(l.endContainer.$, l.endOffset); else throw C;
                                }
                                f.addRange(u)
                            }
                        }
                ...
                a.isFake && (c = b[0].getEnclosedNode(), c && c.type == CKEDITOR.NODE_ELEMENT || (CKEDITOR.warn("selection-not-fake"),
                    a.isFake = 0));
    ...
    (function () {
        ...
        function b(c) {
            var f = c.document;
            if (c.collapsed)f = H(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
                var g = this.element, h = this._.definition, k, l = h.ignoreReadonly, n = l || h.includeReadonly;
                null ==
                ...
                c.trim();
                var p = c.createBookmark(), q = p.startNode, v = p.endNode, r = q, t;
                if (!l) {
                    var u = c.getCommonAncestor(), l = a(q, u), u = a(v, u);
                    l && (r = l.getNextSourceNode(!0));
                    u && (v = u)
                }
                for (r.getPosition(v) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    l = !1;
                    if (r.equals(v))r = null, l = !0; else {
                        var y = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null, u = y && "false" == r.getAttribute("contentEditable"), w = y &&
                            r.getAttribute("data-nostyle");
                        if (y && r.data("cke-bookmark")) {
                            r = r.getNextSourceNode(!0);
                            continue
                        }
                        if (u && n && CKEDITOR.dtd.$block[y])for (var A = r, x = e(A), z = void 0, B = x.length, E = 0, A = B && new CKEDITOR.dom.range(A.getDocument()); E < B; ++E) {
                            var z = x[E], F = CKEDITOR.filter.instances[z.data("cke-filter")];
                            if (F ? F.check(this) : 1)A.selectNodeContents(z), b.call(this, A)
                        }
                        x = y ? !m[y] || w ? 0 : u && !n ? 0 : d(r, v, h, O) : 1;
                        if (x)if (z = r.getParent(), x = h, B = g, E = k, !z || !(z.getDtd() || CKEDITOR.dtd.span)[B] && !E || x.parentRule && !x.parentRule(z))l = !0; else {
                            if (t ||
                                y && CKEDITOR.dtd.$removeEmpty[y] && (r.getPosition(v) | O) != O || (t = c.clone(), t.setStartBefore(r)), y = r.type, y == CKEDITOR.NODE_TEXT || u || y == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) {
                                for (var y = r, P; (l = !y.getNext(Y)) && (P = y.getParent(), m[P.getName()]) && d(P, q, h, N);)y = P;
                                t.setEndAfter(y)
                            }
                        } else l = !0;
                        r = r.getNextSourceNode(w || u)
                    }
                    if (l && t && !t.collapsed) {
                        for (var l = H(this, f), u = l.hasAttributes(), w = t.getCommonAncestor(), y = {}, x = {}, z = {}, B = {}, S, V, ca; l && w;) {
                            if (w.getName() == g) {
                                for (S in h.attributes)!B[S] && (ca = w.getAttribute(V)) &&
                                (l.getAttribute(S) == ca ? x[S] = 1 : B[S] = 1);
                                for (V in h.styles)!z[V] && (ca = w.getStyle(V)) && (l.getStyle(V) == ca ? y[V] = 1 : z[V] = 1)
                            }
                            w = w.getParent()
                        }
                        for (S in x)l.removeAttribute(S);
                        for (V in y)l.removeStyle(V);
                        u && !l.hasAttributes() && (l = null);
                        l ? (t.extractContents().appendTo(l), t.insertNode(l), D.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), t.extractContents().appendTo(l), t.insertNode(l), D.call(this, l), l.remove(!0));
                        t = null
                    }
                }
                c.moveToBookmark(p);
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, g = 0, k; g < e.elements.length && (k = e.elements[g]) && k != e.block && k != e.blockLimit; g++)if (this.checkElementRemovable(k)) {
                    var l;
                    a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (l = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (f = k, f.match = l ? "start" : "end") : (k.mergeSiblings(), k.is(this.element) ? r.call(this, k) : n(k, h(this)[k.getName()]))
                }
                if (f) {
                    k = d;
                    for (g = 0; ; g++) {
                ...
                b();
                for (e = d; !e.equals(m);)f = e.getNextSourceNode(), e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? r.call(this, e) : n(e, h(this)[e.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())), e = f
            }
            a.moveToBookmark(c);
        ...
        function l(a) {
            ...
            for (var d, e = a.document, f; d = c.getNextParagraph();)!d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = H(this, e, d), v(d, f));
            a.moveToBookmark(b)
        }
        ...
        function q(a) {
            ...
            (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), v(d, e)) : r.call(this, d));
            a.moveToBookmark(b)
        }
        ...
        function v(a, b) {
            ...
            if (d) {
                var c = b, k;
                (k = c.getPrevious(P)) && k.type == CKEDITOR.NODE_ELEMENT && k.is("pre") && (d = y(k.getHtml(), /\n$/, "") + "\n\n" + y(c.getHtml(), /^\n/, ""), CKEDITOR.env.ie ? c.$.outerHTML = "\x3cpre\x3e" + d + "\x3c/pre\x3e" :
        ...
        function D(a) {
            for (var b = h(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;)d = c.getItem(e), d.isReadOnly() || r.call(this, d, !0);
            for (var f in b)if (f != this.element)for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--)d = c.getItem(e), d.isReadOnly() || n(d, b[f])
        }
        ...
        function w(a, b) {
            if (!a.hasAttributes() || b)if (CKEDITOR.dtd.$block[a.getName()]) {
                var c = a.getPrevious(P), d = a.getNext(P);
        ...
        var z = {
            ...
            audio: 1,
            video: 1
        }, B = /\s*(?:;\s*|$)/, E = /#\((.+?)\)/g, Y = CKEDITOR.dom.walker.bookmark(0,
            1), P = CKEDITOR.dom.walker.whitespaces(1);
        CKEDITOR.style = function (a, b) {
            ...
            b && (a = CKEDITOR.tools.clone(a), t(a.attributes, b), t(a.styles, b));
            c = this.element = a.element ? "string" == typeof a.element ? a.element.toLowerCase() : a.element : "*";
            this.type = a.type || (z[c] ? CKEDITOR.STYLE_BLOCK : F[c] ? CKEDITOR.STYLE_OBJECT :
        ...
        CKEDITOR.style.prototype = {
            apply: function (a) {
                ...
                this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? l : this.type == CKEDITOR.STYLE_OBJECT ? g : null;
                return this.applyToRange(a)
            }, removeFromRange: function (a) {
                this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? q : this.type == CKEDITOR.STYLE_OBJECT ? k : null;
                ...
                if ("string" == typeof this.element ? d == this.element : d in this.element) {
                    ...
                    if (c._length) {
                        for (var h in c)if ("_length" != h)if (d = a.getAttribute(h) || "", "style" == h ? m(c[h], d) : c[h] == d) {
                            if (!b)return !0
                        } else if (b)return !1;
                        if (b)return !0
                    } else return !0
        ...
        CKEDITOR.style.getStyleText = function (a) {
            ...
            c.length && (c = c.replace(B, ";"));
            for (var e in b) {
                var f = b[e], g = (e + ":" + f).replace(B, ";");
                "inherit" == f ? d += g : c += g
            }
        ...
        attachStyleStateChange: function (a, d) {
            ...
            b || (b = this._.styleStateChangeCallbacks = [], this.on("selectionChange", function (a) {
                for (var d = 0; d < b.length; d++) {
                    var g = b[d], k = g.style.checkActive(a.data.path, this) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
                    g.fn.call(this, k)
                }
            }));
            b.push({style: a, fn: d})
    ...
    (function () {
        ...
        CKEDITOR.dom.elementPath = function (b, e) {
            ...
            do if (q.type == CKEDITOR.NODE_ELEMENT) {
                ...
                if (q.equals(e))break;
                if (!k && (v = q.getName(),
                        "true" == q.getAttribute("contenteditable") ? k = q : !g && d[v] && (g = q), a[v])) {
                    if (v = !g && "div" == v) {
                        a:{
                            v = q.getChildren();
                            for (var f = 0, y = v.count(); f < y; f++) {
                                var A = v.getItem(f);
    ...
    (function () {
        function a(a, c, d) {
            var g = a.serializable, k = c[d ? "endContainer" : "startContainer"], l = d ? "endOffset" : "startOffset", q = g ? c.document.getById(a.startNode) : a.startNode;
            a = g ? c.document.getById(a.endNode) : a.endNode;
            k.equals(q.getPrevious()) ? (c.startOffset = c.startOffset - k.getLength() - a.getPrevious().getLength(), k = a.getNext()) : k.equals(a.getPrevious()) && (c.startOffset -= k.getLength(), k = a.getNext());
            k.equals(q.getParent()) && c[l]++;
            k.equals(a.getParent()) && c[l]++;
                ...
                return {
                    getNextRange: function (k) {
                        ...
                        if (l && 1 < a.length) {
                            ...
                            if (k)for (var v = 0; a[g + v + 1];) {
                                var f = l.document;
                                k = 0;
                                q = f.getById(d[v].endNode);
                                for (f = f.getById(d[v + 1].startNode); ;) {
                                    q =
                                        q.getNextSourceNode(!1);
                                    if (f.equals(q))k = 1; else if (c(q) || q.type == CKEDITOR.NODE_ELEMENT && q.isBlockBoundary())continue;
                                    break
                                }
                                if (!k)break;
                                v++
                            }
                            for (l.moveToBookmark(d.shift()); v--;)q = a[++g], q.moveToBookmark(d.shift()), l.setEnd(q.endContainer, q.endOffset)
                        }
                        return l
                    }
                }
    ...
    (function () {
        ...
        var k = "cke_ui_color", l = [], q = /\$color/g;
    ...
    (function () {
        ...
        function y(b) {
            ...
            function z() {
                if ("paste" ==
                    n.mainPasteEvent)return b.fire("beforePaste", {type: "auto", method: "paste"}), !1;
                b.focus();
                e();
                ...
                addBlock: function (a, b) {
                    ...
                    CKEDITOR.tools.setTimeout(function () {
                        var a = CKEDITOR.tools.bind(function () {
                            ...
                            a.removeStyle("width");
                            if (p.autoSize) {
                                var b = p.element.getDocument(), b = (CKEDITOR.env.webkit || CKEDITOR.env.edge ? p.element : b.getBody()).$.scrollWidth;
    ...
    CKEDITOR.plugins.add("colorbutton", {
        requires: "panelbutton,floatpanel", init: function (c) {
            function r(p, h, e, f) {
                var l = new CKEDITOR.style(k["colorButton_" + h + "Style"]), m = CKEDITOR.tools.getNextId() + "_colorBox";
            ...
            function u(p, h, e) {
                var f = [], l = k.colorButton_colors.split(","), m = c.plugins.colordialog && !1 !== k.colorButton_enableMore, a = l.length + (m ? 2 : 1), b = CKEDITOR.tools.addFunction(function (a, b) {
                    ...
                    if ("?" == a)c.openDialog("colordialog", function () {
                        ...
                        p.hide();
                        c.fire("saveSnapshot");
                        c.removeStyle(new CKEDITOR.style(k["colorButton_" + b + "Style"], {color: "inherit"}));
                        if (a) {
            ...
            var k = c.config, g = c.lang.colorbutton;
    ...
    CKEDITOR.plugins.add("specialchar", {
        availableLangs: {
            ...
            a.addCommand("specialchar", {
                exec: function () {
                    var b =
                        a.langCode, b = c.availableLangs[b] ? b : c.availableLangs[b.replace(/-.*/, "")] ? b.replace(/-.*/, "") : "en";
        ...
        requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", init: function (a) {
            ...
            a.plugins.wsc && (b.WSC = {
                label: a.lang.wsc.toolbar, group: "scaytButton", onClick: function () {
                    var b = CKEDITOR.plugins.scayt, d = a.scayt, c = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? a.container.getText() : a.document.getBody().getText();
            ...
            a.on("afterCommandExec", function (b) {
                "wysiwyg" != a.mode || "undo" != b.data.name && "redo" != b.data.name || setTimeout(function () {
                    var b = a.scayt, d = b && b.getScaytLangList();
            ...
            a.on("reloadMarkupScayt", function (b) {
                ...
                setTimeout(function () {
                    var b = a.scayt, c = b && b.getScaytLangList();
                    c && c.ltr && c.rtl && (a.document.fire("keydown", new CKEDITOR.dom.event({keyCode: 37})), b.removeMarkupInSelectionNode(d), b.fire("startSpellCheck, startGrammarCheck"))
                }, b.data &&
                    b.data.timeout || 0)
            });
            ...
            if (a.config.scayt_disableOptionsStorage) {
                var c = CKEDITOR.tools.isArray(a.config.scayt_disableOptionsStorage) ? a.config.scayt_disableOptionsStorage : "string" === typeof a.config.scayt_disableOptionsStorage ? [a.config.scayt_disableOptionsStorage] : void 0, e = "all options lang ignore-all-caps-words ignore-domain-names ignore-words-with-mixed-cases ignore-words-with-numbers".split(" "),
                    f = ["lang", "ignore-all-caps-words", "ignore-domain-names", "ignore-words-with-mixed-cases", "ignore-words-with-numbers"], g = CKEDITOR.tools.search, h = CKEDITOR.tools.indexOf;
                a.config.scayt_disableOptionsStorage = function (a) {
                    for (var b = [], d = 0; d < a.length; d++) {
                        var c = a[d], m = !!g(a, "options");
            ...
            var c = CKEDITOR.plugins.scayt,
                d = a.dataProcessor, b = d && d.htmlFilter, e = a._.elementsPath && a._.elementsPath.filters, d = d && d.dataFilter, f = a.addRemoveFormatFilter, g = function (b) {
            ...
            b && b.addRules({
                elements: {
                    span: function (a) {
                        var b = a.hasClass(c.options.misspelled_word_class) && a.attributes[c.options.data_attribute_name], d = a.hasClass(c.options.problem_grammar_class) && a.attributes[c.options.problem_grammar_data_attribute];
                        c && (b || d) && delete a.name;
                        return a
                    }
                }
            ...
            var b = {}, e = {}, f = d ? "word" : "phrase", g = d ? "startGrammarCheck" : "startSpellCheck", h = a.scayt;
            if (0 < c.length && "no_any_suggestions" !== c[0])if (d)for (d = 0; d < c.length; d++) {
                ...
                group: "grayt_suggest",
                order: d + 1
            }), b[k] = CKEDITOR.TRISTATE_OFF; else b.no_scayt_suggest = CKEDITOR.TRISTATE_DISABLED, a.addCommand("no_scayt_suggest", {
                exec: function () {
                }
            ...
            for (var l in b)h && -1 == CKEDITOR.tools.indexOf(f, l.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || (e[l] = "undefined" != typeof b[l].state ? b[l].state : CKEDITOR.TRISTATE_OFF, "function" !== typeof b[l].verification || b[l].verification(a) || delete e[l], a.addCommand(l, {exec: b[l].exec}), a.addMenuItem(l, {
    ...
    CKEDITOR.plugins.scayt = {
        ...
        createScayt: function (a) {
            ...
            this.loadScaytLibrary(a, function (a) {
                ...
                (e["ignore-domain-names"] = a.config.scayt_ignoreDomainNames), "boolean" === typeof a.config.scayt_ignoreWordsWithMixedCases && (e["ignore-words-with-mixed-cases"] = a.config.scayt_ignoreWordsWithMixedCases), "boolean" === typeof a.config.scayt_ignoreWordsWithNumbers && (e["ignore-words-with-numbers"] = a.config.scayt_ignoreWordsWithNumbers), e = new SCAYT.CKSCAYT(e, function () {
                }, function () {
                }), e.subscribe("suggestionListSend", function (a) {
    ...
    CKEDITOR.on("scaytReady", function () {
            ...
            a.checkDirty = CKEDITOR.tools.override(a.checkDirty, function (a) {
                return function () {
                    ...
                    if (CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state.scayt[this.name] && this.scayt) {
                        if (b = "ready" == this.status)var f = c.removeMarkupFromString(this.getSnapshot()), c = c.removeMarkupFromString(this._.previousValue), b = b && c !== f
                    } else b = a.call(this);
                    return b
                }
            });
        ...
        if (!0 === CKEDITOR.config.scayt_handleUndoRedo) {
            ...
            a[c] = CKEDITOR.tools.override(a[c], function (a) {
                return function (b) {
                    var c = b.editor.scayt, f = this.contents, g = b.contents, h = null;
                    CKEDITOR.plugins.scayt &&
